...
def main(
    ...
    try:
        ...
        try:
            ...
            return
        with CameraCapture(videoPath, imageProcessingEndpoint, imageProcessingParams, showVideo, verbose, loopVideo, convertToGray,
                 resizeWidth, resizeHeight, annotate, send_to_Hub_callback,delay=delay, computerVisionEndpoint_FULL=endpoint, computerVisionKey=key) as cameraCapture:
            cameraCapture.start()
...
if __name__ == '__main__':
    try:
        ...
        IMAGE_PROCESSING_PARAMS = os.getenv('IMAGE_PROCESSING_PARAMS', "\'{\"visualFeatures\":\"tags\"}\'")
        ...
        sys.exit(1)
    print(ENDPOINT)
    main(VIDEO_PATH, IMAGE_PROCESSING_ENDPOINT, IMAGE_PROCESSING_PARAMS, SHOW_VIDEO, VERBOSE, LOOP_VIDEO, CONVERT_TO_GRAY, RESIZE_WIDTH, RESIZE_HEIGHT, ANNOTATE, delay=DELAY, endpoint=ENDPOINT, key=KEY)
